...
class RecordField : SchemaBase
{
     ...
     */
    SumType!(None, string) doc_;
    /**
     * The field type
     */
    @typeDSL SumType!(PrimitiveType, RecordSchema, EnumSchema, ArraySchema, string, SumType!(PrimitiveType, RecordSchema, EnumSchema, ArraySchema, string)[]) type_;
...
class RecordSchema : SchemaBase
{
     ...
     */
    @idMap("name", "type") SumType!(None, RecordField[]) fields_;
    /**
     * Must be `record`
     */
...
class ArraySchema : SchemaBase
{
     ...
     */
    SumType!(PrimitiveType, RecordSchema, EnumSchema, ArraySchema, string, SumType!(PrimitiveType, RecordSchema, EnumSchema, ArraySchema, string)[]) items_;
    /**
     * Must be `array`
     */
...
class File : SchemaBase
{
     ...
     */
    @link SumType!(None, string) location_;
    /**
     ...
     * `permanentFailure`.
     */
    @link SumType!(None, string) path_;
    /**
     ...
     */
    SumType!(None, SumType!(File, Directory)[]) secondaryFiles_;
    /**
     ...
     */
    @link SumType!(None, string) format_;
    /**
...
class Directory : SchemaBase
{
     ...
     * merged.
     */
    SumType!(None, SumType!(File, Directory)[]) listing_;
...
class InputRecordSchema : SchemaBase
{
     ...
     * Defines the fields of the record.
     */
    @idMap("name", "type") SumType!(None, InputRecordField[]) fields_;
    /**
     * Must be `record`
     */
    static immutable type_ = "record";
...
class InputArraySchema : SchemaBase
{
     ...
     * Defines the type of the array elements.
     */
    SumType!(CWLType, InputRecordSchema, InputEnumSchema, InputArraySchema, string, SumType!(CWLType, InputRecordSchema, InputEnumSchema, InputArraySchema, string)[]) items_;
    /**
     * Must be `array`
     */
    static immutable type_ = "array";
...
class OutputRecordSchema : SchemaBase
{
     ...
     * Defines the fields of the record.
     */
    @idMap("name", "type") SumType!(None, OutputRecordField[]) fields_;
    /**
     * Must be `record`
     */
    static immutable type_ = "record";
...
class OutputArraySchema : SchemaBase
{
     ...
     * Defines the type of the array elements.
     */
    SumType!(CWLType, OutputRecordSchema, OutputEnumSchema, OutputArraySchema, string, SumType!(CWLType, OutputRecordSchema, OutputEnumSchema, OutputArraySchema, string)[]) items_;
    /**
     * Must be `array`
     */
    static immutable type_ = "array";
...
class InputParameter : SchemaBase
{
     ...
     */
    SumType!(None, string, Expression, SumType!(string, Expression)[]) secondaryFiles_;
    /**
     * Only valid when `type: File` or is an array of `items: File`.
     ...
     */
    @link SumType!(None, string, string[], Expression) format_;
    /**
     ...
     */
    SumType!(None, Any) default_;
    /**
     * Specify valid types of data that may be assigned to this parameter.
     */
    @typeDSL SumType!(None, CWLType, InputRecordSchema, InputEnumSchema, InputArraySchema, string, SumType!(CWLType, InputRecordSchema, InputEnumSchema, InputArraySchema, string)[]) type_;
...
class OutputParameter : SchemaBase
{
     ...
     */
    @link SumType!(None, string, Expression) format_;
...
class InlineJavascriptRequirement : SchemaBase
{
     ...
     */
    SumType!(None, string[]) expressionLib_;
...
class SchemaDefRequirement : SchemaBase
{
     ...
     */
    SumType!(InputRecordSchema, InputEnumSchema, InputArraySchema)[] types_;
...
class EnvironmentDef : SchemaBase
{
     ...
     */
    SumType!(string, Expression) envValue_;
...
class CommandLineBinding : SchemaBase
{
     ...
     */
    SumType!(None, string, Expression) valueFrom_;
    /**
...
class CommandOutputBinding : SchemaBase
{
     ...
     * actually exist.
     */
    SumType!(None, string, Expression, string[]) glob_;
    /**
     ...
     */
    SumType!(None, string, Expression) outputEval_;
...
class CommandInputRecordSchema : SchemaBase
{
     ...
     * Defines the fields of the record.
     */
    @idMap("name", "type") SumType!(None, CommandInputRecordField[]) fields_;
    /**
     * Must be `record`
     */
    static immutable type_ = "record";
...
class CommandInputArraySchema : SchemaBase
{
     ...
     * Defines the type of the array elements.
     */
    SumType!(CWLType, CommandInputRecordSchema, CommandInputEnumSchema, CommandInputArraySchema, string, SumType!(CWLType, CommandInputRecordSchema, CommandInputEnumSchema, CommandInputArraySchema, string)[]) items_;
    /**
     * Must be `array`
     */
    static immutable type_ = "array";
...
class CommandOutputRecordSchema : SchemaBase
{
     ...
     * Defines the fields of the record.
     */
    @idMap("name", "type") SumType!(None, CommandOutputRecordField[]) fields_;
    /**
     * Must be `record`
     */
    static immutable type_ = "record";
...
class CommandOutputArraySchema : SchemaBase
{
     ...
     * Defines the type of the array elements.
     */
    SumType!(CWLType, CommandOutputRecordSchema, CommandOutputEnumSchema, CommandOutputArraySchema, string, SumType!(CWLType, CommandOutputRecordSchema, CommandOutputEnumSchema, CommandOutputArraySchema, string)[]) items_;
    /**
     * Must be `array`
     */
    static immutable type_ = "array";
...
class CommandInputParameter : SchemaBase
{
     ...
     * Specify valid types of data that may be assigned to this parameter.
     */
    @typeDSL SumType!(None, CWLType, CommandInputRecordSchema, CommandInputEnumSchema, CommandInputArraySchema, string, SumType!(CWLType, CommandInputRecordSchema, CommandInputEnumSchema, CommandInputArraySchema, string)[]) type_;
...
class CommandOutputParameter : SchemaBase
{
     ...
     * Specify valid types of data that may be assigned to this parameter.
     */
    @typeDSL SumType!(None, CWLType, stdout, stderr, CommandOutputRecordSchema, CommandOutputEnumSchema, CommandOutputArraySchema, string, SumType!(CWLType, CommandOutputRecordSchema, CommandOutputEnumSchema, CommandOutputArraySchema, string)[]) type_;
...
@documentRoot class CommandLineTool : SchemaBase
{
     ...
     */
    @idMap("class") SumType!(None, SumType!(InlineJavascriptRequirement, SchemaDefRequirement, DockerRequirement, SoftwareRequirement, InitialWorkDirRequirement, EnvVarRequirement, ShellCommandRequirement, ResourceRequirement, SubworkflowFeatureRequirement, ScatterFeatureRequirement, MultipleInputFeatureRequirement, StepInputExpressionRequirement)[]) requirements_;
    /**
     ...
     */
    @idMap("class") SumType!(None, Any[]) hints_;
    /**
     * A short, human-readable label of this process object.
     */
    SumType!(None, string) label_;
     ...
     * executable.
     */
    SumType!(None, string, string[]) baseCommand_;
    /**
     * Command line bindings which are not directly associated with input parameters.
     */
    SumType!(None, SumType!(string, Expression, CommandLineBinding)[]) arguments_;
    /**
     * A path to a file whose contents must be piped into the command's
     * standard input stream.
     */
    SumType!(None, string, Expression) stdin_;
    /**
     ...
     */
    SumType!(None, string, Expression) stderr_;
    /**
     ...
     * characters (such as the path separator `/`) it is an error.
     */
    SumType!(None, string, Expression) stdout_;
    /**
     * Exit codes that indicate the process completed successfully.
     */
    SumType!(None, int[]) successCodes_;
    /**
     ...
     */
    SumType!(None, int[]) temporaryFailCodes_;
    /**
     ...
     */
    SumType!(None, int[]) permanentFailCodes_;
...
class DockerRequirement : SchemaBase
{
     ...
     * must be used.
     */
    SumType!(None, string) dockerImageId_;
    /**
     * Set the designated output directory to a specific location inside the
     * Docker container.
     */
    SumType!(None, string) dockerOutputDirectory_;
...
class Dirent : SchemaBase
{
     ...
     */
    SumType!(None, string, Expression) entryname_;
    /**
     ...
     * file.
     */
    SumType!(string, Expression) entry_;
    /**
...
class InitialWorkDirRequirement : SchemaBase
{
     ...
     */
    SumType!(SumType!(File, Directory, Dirent, string, Expression)[], string, Expression) listing_;
...
class ResourceRequirement : SchemaBase
{
     ...
     */
    SumType!(None, long, string, Expression) coresMin_;
    /**
     * Maximum reserved number of CPU cores
     */
    SumType!(None, int, string, Expression) coresMax_;
    /**
     * Minimum reserved RAM in mebibytes (2**20)
     */
    SumType!(None, long, string, Expression) ramMin_;
    /**
     * Maximum reserved RAM in mebibytes (2**20)
     */
    SumType!(None, long, string, Expression) ramMax_;
    /**
     * Minimum reserved filesystem based storage for the designated temporary directory, in mebibytes (2**20)
     */
    SumType!(None, long, string, Expression) tmpdirMin_;
    /**
     * Maximum reserved filesystem based storage for the designated temporary directory, in mebibytes (2**20)
     */
    SumType!(None, long, string, Expression) tmpdirMax_;
    /**
     * Minimum reserved filesystem based storage for the designated output directory, in mebibytes (2**20)
     */
    SumType!(None, long, string, Expression) outdirMin_;
    /**
     * Maximum reserved filesystem based storage for the designated output directory, in mebibytes (2**20)
     */
    SumType!(None, long, string, Expression) outdirMax_;
...
class ExpressionToolOutputParameter : SchemaBase
{
     ...
     * Specify valid types of data that may be assigned to this parameter.
     */
    @typeDSL SumType!(None, CWLType, OutputRecordSchema, OutputEnumSchema, OutputArraySchema, string, SumType!(CWLType, OutputRecordSchema, OutputEnumSchema, OutputArraySchema, string)[]) type_;
...
@documentRoot class ExpressionTool : SchemaBase
{
     ...
     */
    SumType!(string, Expression) expression_;
...
class WorkflowOutputParameter : SchemaBase
{
     ...
     * the output parameter.
     */
    @link SumType!(None, string, string[]) outputSource_;
    /**
     * The method to use to merge multiple sources into a single array.
     * If not specified, the default method is "merge_nested".
     */
    SumType!(None, LinkMergeMethod) linkMerge_;
    /**
     * Specify valid types of data that may be assigned to this parameter.
     */
    @typeDSL SumType!(None, CWLType, OutputRecordSchema, OutputEnumSchema, OutputArraySchema, string, SumType!(CWLType, OutputRecordSchema, OutputEnumSchema, OutputArraySchema, string)[]) type_;
...
class WorkflowStepInput : SchemaBase
{
     ...
     */
    @link SumType!(None, string, string[]) source_;
    /**
...
class WorkflowStep : SchemaBase
{
     ...
     * used to generate and/or validate the output object.
     */
    @link SumType!(SumType!(string, WorkflowStepOutput)[]) out_;
    /**
     * Declares requirements that apply to either the runtime environment or the
     ...
     */
    SumType!(None, ScatterMethod) scatterMethod_;
...
@documentRoot class Workflow : SchemaBase
{
     ...
     */
    @idMap("id") SumType!(WorkflowStep[]) steps_;
